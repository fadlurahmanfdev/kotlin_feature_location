...
//        )
    ...
    override fun onClicked(item: FeatureModel) {
        when (item.enum) {
            ...
            "CURRENT_LOCATION" -> {
                featureLocation.getCurrentLocation().addOnSuccessListener {
                    Log.d(
                        this::class.java.simpleName,
                        "success get current location: ${it.latitude} & ${it.longitude}"
                    )
                }.addOnFailureListener {
            ...
            "GET_ADDRESS" -> {
                featureLocation.getCurrentLocation().addOnSuccessListener {
                    Log.d(this::class.java.simpleName, "success get current location: $it")
                }.addOnFailureListener {
                    Log.e(this::class.java.simpleName, "failed get current location: ${it.message}")
                }.addOnCompleteListener {
                    Log.d(this::class.java.simpleName, "completed get current location: $it")
                    featureLocation.getAddressesByCoordinate(
                        ...
                        callback = object : FeatureLocation.RequestAddressCallback {
                            ...
                            override fun onFailedGetAddress(exception: FeatureLocationException) {
                                Log.e(this::class.java.simpleName, "failed: $exception")
                            }
                        }
                    )
                }
